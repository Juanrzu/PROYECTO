...
<head>
    ...
    <!-- Loading Screen -->
    <div class="container-loading fixed inset-0 flex items-center justify-center w-screen h-screen bg-gray-700 bg-opacity-75 z-50">
        <div role="status">
    ...
    <main class="container h-screen mx-auto px-4 py-8">
        ...
        <!-- Botón de Ayuda -->
        <button data-tooltip-target="tooltip" type="button" class="fixed right-6 bottom-6 bg-blue-600 text-white rounded-full p-4 shadow-lg hover:bg-blue-700 transition-colors duration-200 outline-none focus:ring-4 focus:ring-blue-300">
