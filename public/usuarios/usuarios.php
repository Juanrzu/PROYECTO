...
<div class="container-loading fixed flex items-center justify-center w-screen h-screen bg-gray-700 z-50">
    ...
    ?>
        ...
        <main class="h-full mt-4">
                ...
                <?php echo ' 
                <div class="container-buttons flex justify-between items-center flex-wrap md:flex-nowrap  mx-5">
                            <div class="w-full p-4">
                            
                                    <button class="py-2  rounded-md ghost bg-blue-400 shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 drop-shadow-lg"><a href="../login/registro.php " class="inline-block px-2 py-3"><p class=" mx-auto">Agregar Usuario</p></a></button>
                                    <button class="py-2  mx-2 rounded-md  ghost bg-blue-400 shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 drop-shadow-lg"><a href="actualizar_preguntas.php " class="inline-block px-2 py-3"><p class="mx-auto">Actualizar Preguntas</p></a></button>
                ...
                <table class="w-full text-xs text-left rtl:text-right text-black dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        if (isset($_POST['buscador'])){
                            ...
                            $sql = "SELECT * 
                            FROM usuario 
                            WHERE usuario.nombre LIKE '%$nombre%' or usuario.nombre_usuario LIKE '%$nombre%' 
                            or usuario.apellido LIKE '%$nombre%' or usuario.cedula LIKE '%$nombre%' 
                            or usuario.telefono LIKE '%$nombre%' or usuario.nombre_usuario LIKE '%$nombre%'
                            or usuario.correo LIKE '%$nombre%'
                         ...
                         <th scope="row" class="px-3 py-2 font-medium text-black whitespace-nowrap bg-gray-200 dark:text-white dark:bg-gray-800">  
                          ...
                          <td class="text-center px-3 py-2 bg-blue-400 dark:bg-blue-800 hover:bg-blue-500">
                              <button class=" w-1/2">
                         ...
                         <th scope="row" class="px-3 py-2 font-medium text-black whitespace-nowrap bg-gray-200 dark:text-white dark:bg-gray-800">  
                          ...
                          <button class="w-full">
                          <a href="eliminar_usuario.php? eliminarid=' . $id . '" class="px-3 py-2">
                                  <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 -0.5 21 21" version="1.1">
                                  ...
                                  <g id="Page-1" stroke="none" stroke-width="1" fill="#f8b4b4" fill-rule="evenodd">
                                      <g id="Dribbble-Light-Preview" transform="translate(-179.000000, -360.000000)" fill="#000">
                            ...
                            FROM usuario ORDER BY nombre_usuario ASC";
