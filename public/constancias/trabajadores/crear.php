...
<body class="bg-ghost">
  ...
  <?php  echo '<button class=" p-4  rounded-md ghost bg-blue-400 shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 drop-shadow-lg"><a href="http://localhost/dashboard/Proyecto/public/trabajadores/ag_trabajador.php ">Agregar Trabajador</a></button>';
  ?>
  </div>
  ...
  <thead class="text-xs text-black uppercase dark:text-gray-400">
      <tr>
        ...
        <th scope="col" class="px-3 py-2 bg-gray-200 dark:bg-gray-800">ID</th>
        <th scope="col" class="px-3 py-2 ">Nombre</th>
        <th scope="col" class="px-3 py-2 bg-gray-200 dark:bg-gray-800">Apellido</th>
      ...
      if ($result) {
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            $rol = $row['rol'];
              ...
              echo  '<tr>
                      <td class="px-3 py-2 bg-gray-200 dark:bg-gray-800">' . $id. '</td>
                      <td>' . $nombre . '</td>
