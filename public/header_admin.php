<header class="w-full flex items-center justify-between px-6 py-3 shadow-md bg-white border-b border-gray-200">
  <!-- Botón del menú -->
  <button class="p-2 rounded-md hover:bg-gray-100 transition-colors" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
    <svg width="28px" height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4 18L20 18" stroke="#4B5563" stroke-width="2" stroke-linecap="round"/>
      <path d="M4 12L20 12" stroke="#4B5563" stroke-width="2" stroke-linecap="round"/>
      <path d="M4 6L20 6" stroke="#4B5563" stroke-width="2" stroke-linecap="round"/>
    </svg>
  </button>
  ...
  <!-- Menú lateral -->
  <div id="drawer-navigation" class="fixed top-0 left-0 z-50 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white shadow-lg" tabindex="-1" aria-labelledby="drawer-navigation-label">
    <div class="flex justify-between items-center mb-6">
      <h5 id="drawer-navigation-label" class="text-lg font-semibold text-gray-800 uppercase">Menú</h5>
      <button type="button" data-drawer-hide="drawer-navigation" class="text-gray-500 hover:text-gray-700">
