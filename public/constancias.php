            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <a href="constancias/estudio/estudio.php"
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <a href="constancias/trabajadores/crear.php"
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <a href="constancias/inscripcion/ver_alumnos.php"
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <a href="constancias/aceptacion/ver_alumnos.php"
