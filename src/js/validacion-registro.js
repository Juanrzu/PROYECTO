   ...
   form.addEventListener("submit", (e)=>{
       ...
       if (regexEmail.test(email.value)){
         ...
         email.classList.remove('is-valid');
              ...
              if(pass.value == ""){
                error += "<span class='row'>EL campo Contraseña esta vacio</span>";
                ...
                pass.classList.remove('is-invalid');
                 ...
                 if(p1.value == ""){
                  error += "<span class='row'>Ingrese una pregunta</span>";
               ...
               if(cedula.classList.contains("is-invalid") || nombre.classList.contains("is-invalid") || apellido.classList.contains("is-invalid") ||  pass.classList.contains("is-invalid") || telefono.classList.contains("is-invalid") || email.classList.contains("is-invalid") || usuario.classList.contains("is-invalid") || p1.classList.contains("is-invalid") || p2.classList.contains("is-invalid")){
                  msg.innerHTML = error;
                  e.preventDefault();
                  e.stopPropagation();
                   ...
                   window.location='http://localhost/dashboard/Proyecto/usuarios/usuarios.php';
                }
